...
| Backend | Node.js, Express *(worked with)*, SQLite, MongoDB |
| AI & APIs | AI Integration, API Handling, Prompt Engineering |
| Tools & Platforms | Git, GitHub, Google Colab *(worked with)*, Vercel *(worked with)*, AWS *(worked with)*, RPA *(worked with)* |

---

## Notable Projects (*Innovative*)

### [Not Pi Vision](https://github.com/Sabir-Ali-Mondal/Not-Pi-Vision)
Converting *Text AI* into **visual learning engine.** **My biggest time-consuming project yet.**
...
### [More projects](https://github.com/Sabir-Ali-Mondal?tab=repositories)
